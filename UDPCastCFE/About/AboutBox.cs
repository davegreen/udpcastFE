...
namespace UDPcastCFE
{
    partial class AboutBox : Form
    {
        ...
        private void btnChangelog_Click(object sender, EventArgs e)
        {
            ...
            UDPcastCFE.About.TextDisplay text = new UDPcastCFE.About.TextDisplay("UDPcastCFE.About.Changelog.txt");
            text.Show();
        }
        private void btnHelp_Click(object sender, EventArgs e)
        {
            ...
            //System.Diagnostics.Process.Start(app);
            UDPcastCFE.About.TextDisplay text = new UDPcastCFE.About.TextDisplay("UDPcastCFE.About.Help.txt");
            text.Show();
        }
    }
}
